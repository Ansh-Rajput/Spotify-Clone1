...
const PlayerContent = ({song,songUrl}) => {
  ...
  return (
    <div className='grid grid-cols-2 md:grid-cols-3 h-full'>
      ...
      <div className='hidden h-full w-full justify-center items-center md:flex max-w-[722px] gap-x-6'>
            <AiFillStepBackward size={30} className='text-neutral-400 cursor-pointer hover:text-white transition'
                onClick={onPlayPreviour}
            />
